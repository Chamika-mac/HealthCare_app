...
import com.paf.newProject.HealthCare.DBConnector.Connector;
import com.paf.newProject.HealthCare.model.AppointmentModel;
...
public class AppointmentController {
	...
	public void save(AppointmentModel obj) throws Exception {
		...
		con.aud("INSERT INTO appointment(Name,date,time,doctor_name,email,contactNum,Hospital_Name) VALUES ('"
				+ obj.getName() + "', " + "'" + obj.getDate() + "', '" + obj.getTime() + "', '" + obj.getDoctor_name()
				+ "', '" + obj.getEmail() + "', " + "'" + obj.getContactNum() + "', '" + obj.getHospitalName() + "')");
	}
	...
	public void update(AppointmentModel obj) throws Exception {
		...
		con.aud("UPDATE appointment SET Name = '" + obj.getName() + "', date = '" + obj.getDate() + "', time = '"
				...
				+ "', contactNum='" + obj.getContactNum() + "', Hospital_Name='" + obj.getHospitalName() + "' "
				+ "WHERE appointmentId='" + obj.getAppointementId() + "'");
	}
